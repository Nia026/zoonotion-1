...
function DetailArtikel(){
  ...
  return (
    <div className="bg-brown-light py-5"> {/* bg-brown-light untuk background keseluruhan, py-5 untuk padding atas/bawah */}
      <Container>
        <Row className="justify-content-center mt-5"> {/* Tambahkan mt-5 untuk margin atas jika tidak ada banner */}
          <Col md={10} lg={8}>
